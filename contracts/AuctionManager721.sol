...
contract AuctionManager721 {
    ...
    mapping(uint256 => Auction721) public auctionsByIndex; // auctionsByIndex
    mapping(Auction721 => uint256) public auctionsByAddress;
        ...
        returns (bool)
    {
        ...
        Auction721(auctionsByIndex[auctionId]).placeBid(
            msg.sender,
            transactionFee
        );
        return true;
