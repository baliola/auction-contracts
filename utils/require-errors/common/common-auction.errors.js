...
const CREATOR_CANT_BID = "The auction seller can not place a bid"
...
const ONLY_CREATOR_CAN_WITHDRAW_FUNDS = "The auction seller can only withdraw the funds"
const ONLY_CREATOR_CAN_END_AUCTION = "only the seller can end the auction!"
const CAN_ONLY_END_AUCTION_IF_OPEN = "can only end auction when it's open!"
const ONLY_CREATOR_CAN_CANCEL_AUCTION = "Only the auction seller can cancel the auction"
